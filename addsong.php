...
// Check connection
    ...
    $sql = "INSERT INTO playlist(youtube_link, song_title, album_id)
VALUES ('$youtube_link', '$song_title', '$id')";

    if ($conn->query($sql) === TRUE) {
        echo "Je playlist is aangemaakt <strong><a href='index.php?vid=$id'>Terug naar de start pagina</strong></a>";
    } else {
